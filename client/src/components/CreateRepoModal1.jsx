...
export default function CreateRepoModal1(props) {
                                                    ...
                                                    <div className="col-span-full">
                                                        ...
                                                        <div className="mt-2">
                                                            <textarea
                                                                ...
                                                                rows={2}
                                                                className="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-green-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-green-800 sm:text-sm sm:leading-6"
                                                                defaultValue={''}
                                                            />
                                                        </div>
